        ...
        httpClient
            ...
            .then(async ({ headers, data }) => {
                if (headers['content-disposition'] === undefined) {
                    ...
                    Guestcms.showError(responseJson?.message || $form.data('error-message'))
                ...
                Guestcms.showSuccess($form.data('success-message'))
            })
            .catch((error) => {
                Guestcms.showError(error.message ? (error.statusText + ': ' + error.message) : form.data('error-message'))
            })
    }
