...
namespace GuestcmsDataSynchronize\Exporter;

use GuestcmsBase\Facades\Assets;
use GuestcmsBase\Facades\BaseHelper;
use GuestcmsDataSynchronize\Concerns\Exporter\HasEmptyState;
use GuestcmsDataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \GuestcmsDataSynchronize\Exporter\ExportColumn[]
     */
    ...
    /**
     * @return \GuestcmsDataSynchronize\Exporter\ExportCounter[]
     */
